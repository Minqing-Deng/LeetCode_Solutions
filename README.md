...
### Array / String
- [88. Merge Sorted Array](./Solutions/88_Merge_Sorted_Array.py)
- [27. Remove Element](./Solutions/27_Remove_Element.py)
...
- [135. Candy](./Solutions/135_Candy.py)
- [42. Trapping Rain Water](./Solutions/42_Trapping_Rain_Water.py)
- [13. Roman to Integer](./Solutions/13_Roman_to_Integer.py)
- [12. Integer to Roman](./Solutions/12_Integer_to_Roman.py)
- [58. Length of Last Word](./Solutions/58_Length_of_Last_Word.py)
- [14. Longest Common Prefix](./Solutions/14_Longest_Common_Prefix.py)
- [151. Reverse Words in a String](./Solutions/151_Reverse_Words_in_a_String.py)
...
### Two Pointers
- [125. Valid Palindrome](./Solutions/125_Valid_Palindrome.py)
- [392. Is Subsequence](./Solutions/392_Is_Subsequence.py)
...
### Sliding Window
- [209. Minimum Size Subarray Sum](./Solutions/209_Minimum_Size_Subarray_Sum.py)
...
### Hashmap
- [383. Ransom Note](./Solutions/383_Ransom_Note.py)
- [205. Isomorphic Strings](./Solutions/205_Isomorphic_Strings.py)
- [290. Word Pattern](./Solutions/290_Word_Pattern.py)
- [242. Valid Anagram](./Solutions/242_Valid_Anagram.py)
- [49. Group Anagrams](./Solutions/49_Group_Anagrams.py)
...
### Intervals
- [228. Summary Ranges](./Solutions/228_Summary_Ranges.py)
...
### Stack
- [20. Valid Parentheses](./Solutions/20_Valid_Parentheses.py)
- [71. Simplify Path](./Solutions/71_Simplify_Path.py)
...
### Linked List
- [141. Linked List Cycle](./Solutions/141_Linked_List_Cycle.py)
- [2. Add Two Numbers](./Solutions/2_Add_Two_Numbers.py)
- [21. Merge Two Sorted Lists](./Solutions/21_Merge_Two_Sorted_Lists.py)
- [138. Copy List with Random Pointer](./Solutions/138_Copy_List_with_Random_Pointer.py)
- [92. Reverse Linked List II](./Solutions/92_Reverse_Linked_List_II.py)
- [25. Reverse Nodes in k-Group](./Solutions/25_Reverse_Nodes_in_k_Group.py)
- [19. Remove Nth Node From End of List](./Solutions/19_Remove_Nth_Node_From_End_of_List.py)
- [82. Remove Duplicates from Sorted List II](./Solutions/82_Remove_Duplicates_from_Sorted_List_II.py)
...
### Binary Tree General
- [104. Maximum Depth of Binary Tree](./Solutions/104_Maximum_Depth_of_Binary_Tree.py)
- [100. Same Tree](./Solutions/100_Same_Tree.py)
- [226. Invert Binary Tree](./Solutions/226_Invert_Binary_Tree.py)
...
- [129. Sum Root to Leaf Numbers](./Solutions/129_Sum_Root_to_Leaf_Numbers.py)
...
### Binary Tree BFS
- [199. Binary Tree Right Side View](./Solutions/199_Binary_Tree_Right_Side_View.py)
- [637. Average of Levels in Binary Tree](./Solutions/637_Average_of_Levels_in_Binary_Tree.py)
- [102. Binary Tree Level Order Traversal](./Solutions/102_Binary_Tree_Level_Order_Traversal.py)
- [103. Binary Tree Zigzag Level Order Traversal](./Solutions/103_Binary_Tree_Zigzag_Level_Order_Traversal.py)
...
### Graph General
- [200. Number of Islands](./Solutions/200_Number_of_Islands.py)
- [130. Surrounded Regions](./Solutions/130_Surrounded_Regions.py)
- [133. Clone Graph](./Solutions/133_Clone_Graph.py)
...
### Divide & Conquer
- [108. Convert Sorted Array to Binary Search Tree](./Solutions/108_Convert_Sorted_Array_to_Binary_Search_Tree.py)
...
### Kadane's Algorithm
- [53. Maximum Subarray](./Solutions/53_Maximum_Subarray.py)
- [918. Maximum Sum Circular Subarray](./Solutions/918_Maximum_Sum_Circular_Subarray.py)
...
### Bit Manipulation
- [67. Add Binary](./Solutions/67_Add_Binary.py)
- [190. Reverse Bits](./Solutions/190_Reverse_Bits.py)
